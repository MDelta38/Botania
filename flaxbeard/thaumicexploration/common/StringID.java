...
public class StringID {
    public static String getName() {
        String Output = "";
        try {
            List<String> adjectivesFile = StringID.getList("assets/thaumicexploration/misc/adjectives");
            List<String> animalsFile = StringID.getList("assets/thaumicexploration/misc/animals");
