...
implements IWailaDataProvider {
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> list, IWailaDataAccessor iWailaDataAccessor, IWailaConfigHandler iWailaConfigHandler) {
        ...
        String colour = StatCollector.func_74838_a((String)("item.dyePowder." + ItemDye.field_150921_b[jar.colour] + ".name"));
        list.add(StatCollector.func_74837_a((String)"txwaila.boundJar.network", (Object[])new Object[]{network}));
        list.add(StatCollector.func_74837_a((String)"txwaila.boundJar.colour", (Object[])new Object[]{colour}));
        return list;
    }
