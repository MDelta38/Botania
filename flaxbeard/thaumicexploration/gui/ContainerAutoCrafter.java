...
extends Container {
    ...
    public ContainerAutoCrafter(InventoryPlayer par1InventoryPlayer, TileEntityAutoCrafter par2TileEntityAutoCrafter) {
        ...
        this.func_75146_a(new Slot((IInventory)par2TileEntityAutoCrafter, 0, 64, 16));
        this.func_75146_a((Slot)new SlotFurnace(par1InventoryPlayer.field_70458_d, (IInventory)par2TileEntityAutoCrafter, 1, 64, 48));
        for (i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
