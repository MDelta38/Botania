...
extends GuiContainer {
    ...
    public GuiThinkTank(InventoryPlayer par1InventoryPlayer, TileEntityThinkTank par2TileEntityThinkTank) {
        super((Container)new ContainerThinkTank(par1InventoryPlayer, par2TileEntityThinkTank));
    ...
    protected void func_146976_a(float par1, int par2, int par3) {
        ...
        int i1 = this.furnaceInventory.getCookProgressScaled(28);
