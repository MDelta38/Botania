...
public class StaffRodTransmutative
extends StaffRod {
    ...
    public StaffRodTransmutative(String tag, int capacity, ItemStack item, int craftCost, IWandRodOnUpdate onUpdate, ResourceLocation texture) {
