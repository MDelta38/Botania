...
extends BlockJar {
    ...
    public void func_149749_a(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        TileEntityBoundJar te = (TileEntityBoundJar)par1World.func_147438_o(par2, par3, par4);
        ItemStack drop = new ItemStack(ThaumicExploration.blankSeal, 1, te.getSealColor());
        te.aspect = null;
        te.amount = 0;
        this.func_149642_a(par1World, par2, par3, par4, drop);
    }
    ...
    public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        ...
        if ((te = world.func_147438_o(x, y, z)) == null || !(te instanceof TileEntityBoundJar)) {
            return false;
        }
