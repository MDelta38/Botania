...
extends GuiButtonLexicon {
    ...
    public void func_146112_a(Minecraft par1Minecraft, int par2, int par3) {
        ...
        this.func_73729_b(this.field_146128_h, this.field_146129_i, k == 2 ? 10 : 0, 200, 10, 12);
    ...
    public List<String> getTooltip() {
        return Arrays.asList(EnumChatFormatting.AQUA + StatCollector.func_74838_a((String)"botaniamisc.clickToShare"));
    }
}
