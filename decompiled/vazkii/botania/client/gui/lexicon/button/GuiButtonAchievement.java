...
public class GuiButtonAchievement
extends GuiButtonLexicon {
    ...
    public void func_146112_a(Minecraft par1Minecraft, int par2, int par3) {
        ...
        this.func_73729_b(this.field_146128_h, this.field_146129_i, k == 2 ? 109 : 98, 191, 11, 11);
        ArrayList<String> tooltip = new ArrayList<String>();
        tooltip.add(EnumChatFormatting.YELLOW + StatCollector.func_74838_a((String)"botaniamisc.achievements"));
