...
public class GuiButtonBookmark
extends GuiButtonLexicon {
    ...
    public void func_146112_a(Minecraft mc, int par2, int par3) {
        ...
        if (this.field_146126_j.equals("+")) {
            tooltip.add(StatCollector.func_74838_a((String)"botaniamisc.clickToAdd"));
        } else {
            tooltip.add(String.format(StatCollector.func_74838_a((String)"botaniamisc.bookmark"), this.field_146127_k - 1337 + 1));
            tooltip.add(EnumChatFormatting.GRAY + StatCollector.func_74838_a((String)"botaniamisc.clickToSee"));
            tooltip.add(EnumChatFormatting.GRAY + StatCollector.func_74838_a((String)"botaniamisc.shiftToRemove"));
        }
