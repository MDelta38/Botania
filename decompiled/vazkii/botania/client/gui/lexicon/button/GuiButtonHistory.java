...
extends GuiButtonLexicon {
    ...
    public void func_146112_a(Minecraft mc, int par2, int par3) {
        ...
        tooltip.add(StatCollector.func_74838_a((String)"botaniamisc.historyLong"));
        tooltip.add(EnumChatFormatting.GRAY + StatCollector.func_74838_a((String)"botaniamisc.historyDesc"));
