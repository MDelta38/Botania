...
public class InventoryFlowerBag
implements IInventory {
    ...
    public static boolean isFlowerBag(ItemStack stack) {
        return stack != null && stack.func_77973_b() == ModItems.flowerBag;
    }
    ...
    ItemStack[] getInventory() {
        ...
        if (InventoryFlowerBag.isFlowerBag(this.getStack())) {
            this.stacks = ItemFlowerBag.loadStacks(stack);
            return this.stacks;
        }
    ...
    public int func_70297_j_() {
        return InventoryFlowerBag.isFlowerBag(this.getStack()) ? 64 : 0;
    }

    public boolean func_70300_a(EntityPlayer entityplayer) {
        return InventoryFlowerBag.isFlowerBag(this.getStack());
    }
