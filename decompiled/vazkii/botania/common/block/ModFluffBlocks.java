...
public final class ModFluffBlocks {
    ...
    public static Block[] biomeStoneStairs;
    public static Block[] biomeStoneSlabs;
    public static Block[] biomeStoneFullSlabs;
    public static Block biomeStoneWall;
    public static Block[] stoneStairs;
    public static Block[] stoneSlabs;
    public static Block[] stoneFullSlabs;
    public static Block stoneWall;
    public static Block[] pavementStairs;
    public static Block[] pavementSlabs;
    public static Block[] pavementFullSlabs;
    ...
    public static void init() {
        ...
        if (ConfigHandler.darkQuartzEnabled) {
            darkQuartz = new BlockSpecialQuartz("Dark");
        ...
        manaQuartz = new BlockSpecialQuartz("Mana");
        ...
        blazeQuartz = new BlockSpecialQuartz("Blaze");
        ...
        lavenderQuartz = new BlockSpecialQuartz("Lavender");
        ...
        redQuartz = new BlockSpecialQuartz("Red");
        ...
        elfQuartz = new BlockSpecialQuartz("Elf");
        ...
        sunnyQuartz = new BlockSpecialQuartz("Sunny");
        ...
        for (i = 0; i < 24; ++i) {
            ...
            ModFluffBlocks.biomeStoneStairs[i] = new BlockBiomeStoneStairs(block, meta);
            ModFluffBlocks.biomeStoneSlabs[i] = new BlockBiomeStoneSlab(false, block, meta, i);
            ModFluffBlocks.biomeStoneFullSlabs[i] = new BlockBiomeStoneSlab(true, block, meta, i);
        }
        biomeStoneWall = new BlockBiomeStoneWall();
        for (i = 0; i < 8; ++i) {
            meta = i > 3 ? i + 4 : i;
            ModFluffBlocks.stoneStairs[i] = new Block18StoneStairs(meta);
            ModFluffBlocks.stoneSlabs[i] = new Block18StoneSlab(false, meta, i);
            ModFluffBlocks.stoneFullSlabs[i] = new Block18StoneSlab(true, meta, i);
        }
        stoneWall = new Block18StoneWall();
        for (i = 0; i < pavementStairs.length; ++i) {
            ModFluffBlocks.pavementStairs[i] = new BlockPavementStairs(i);
            ModFluffBlocks.pavementSlabs[i] = new BlockPavementSlab(false, i, i);
            ModFluffBlocks.pavementFullSlabs[i] = new BlockPavementSlab(true, i, i);
        }
        ...
        for (i = 0; i < pavementSlabs.length; ++i) {
    ...
    static {
        biomeStoneStairs = new Block[24];
        biomeStoneSlabs = new Block[24];
        biomeStoneFullSlabs = new Block[24];
        stoneStairs = new Block[8];
        stoneSlabs = new Block[8];
        stoneFullSlabs = new Block[8];
        pavementStairs = new Block[6];
        pavementSlabs = new Block[6];
        pavementFullSlabs = new Block[6];
    }
}
