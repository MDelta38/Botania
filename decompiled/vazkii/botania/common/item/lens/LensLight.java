...
extends Lens {
    ...
    public boolean collideBurst(IManaBurst burst, EntityThrowable entity, MovingObjectPosition pos, boolean isManaBlock, boolean dead, ItemStack stack) {
        ...
        if (!(coords.field_71574_a == pos.field_72311_b && coords.field_71572_b == pos.field_72312_c && coords.field_71573_c == pos.field_72309_d || burst.isFake() || isManaBlock)) {
            ...
            } else if (blockAt_.isAir((IBlockAccess)entity.field_70170_p, x, y, z) || blockAt_.isReplaceable((IBlockAccess)entity.field_70170_p, x, y, z)) {
                entity.field_70170_p.func_147449_b(x, y, z, ModBlocks.manaFlame);
                TileEntity tile = entity.field_70170_p.func_147438_o(x, y, z);
