...
public class ItemSuperLavaPendant
extends ItemBauble
implements IBaubleRender {
    ...
    public void onWornTick(ItemStack stack, EntityLivingBase player) {
        this.setImmunity((Entity)player, true);
    }

    @Override
    public void onUnequipped(ItemStack stack, EntityLivingBase player) {
        this.setImmunity((Entity)player, false);
    }

    private void setImmunity(Entity entity, boolean immune) {
        ReflectionHelper.setPrivateValue(Entity.class, (Object)entity, (Object)immune, (String[])LibObfuscation.IS_IMMUNE_TO_FIRE);
    }
