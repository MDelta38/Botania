...
public class ItemTerrasteelHelmRevealing
extends ItemTerrasteelHelm
implements IGoggles,
IRevealer {
    public ItemTerrasteelHelmRevealing() {
        super("terrasteelHelmReveal");
    }
    ...
    public String getArmorTextureAfterInk(ItemStack stack, int slot) {
        return ConfigHandler.enableArmorModels ? "botania:textures/model/terrasteelNew.png" : "botania:textures/model/terrasteel2.png";
    }
}
