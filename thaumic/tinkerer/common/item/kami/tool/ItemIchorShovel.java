...
implements ITTinkererItem {
    ...
    public ThaumicTinkererRecipe getRecipeItem() {
        return new ThaumicTinkererArcaneRecipe("ICHOR_SHOVEL", "ICHOR_TOOLS", new ItemStack((Item)this), new AspectList().add(Aspect.EARTH, 75), " I ", " R ", " R ", Character.valueOf('R'), new ItemStack(ConfigItems.itemWandRod, 1, 2), Character.valueOf('I'), new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(ItemKamiResource.class), 1, 2));
    }
}
