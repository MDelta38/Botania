...
extends EntityFX {
    ...
    public FXEssentiaTrail(World par1World, double par2, double par4, double par6, double tx, double ty, double tz, int count, int color, float scale) {
        ...
        this.field_70159_w = (double)(MathHelper.func_76126_a((float)((float)count / 4.0f)) * 0.003f) + this.field_70146_Z.nextGaussian() * 0.002000000094994903;
        this.field_70181_x = 0.1f + MathHelper.func_76126_a((float)((float)count / 3.0f)) * 0.002f;
        this.field_70179_y = (double)(MathHelper.func_76126_a((float)((float)count / 2.0f)) * 0.003f) + this.field_70146_Z.nextGaussian() * 0.002000000094994903;
