...
extends AbstractTexture {
    ...
    public void func_110551_a(IResourceManager p_110551_1_) throws IOException {
        ...
        TextureMap allBlocks = Minecraft.func_71410_x().func_147117_R();
        ...
        TextureUtil.func_110989_a((int)this.func_110552_b(), (BufferedImage)this.myImage, (boolean)false, (boolean)false);
    }

    public BufferedImage getIconImage(IIcon icon) throws IOException {
        ResourceLocation resourceLocation = this.getResourceLocation(icon.func_94215_i());
        IResource resource = this.manager.func_110536_a(resourceLocation);
