...
extends EntityBoat {
    ...
    public void func_70071_h_() {
        ...
        if (d10 > 0.26249999999999996) {
            ...
            while ((double)j < 1.0 + d10 * 60.0) {
                ...
                if (this.field_70146_Z.nextBoolean()) {
                    ...
                    } else if (this.field_70146_Z.nextInt(5) == 1) {
                        this.field_70170_p.func_72869_a("lava", d8, this.field_70163_u - 0.125, d9, this.field_70159_w, this.field_70181_x, this.field_70179_y);
                    }
                } else {
        ...
        if (this.field_70170_p.field_72995_K && this.isBoatEmpty) {
            ...
            if (this.field_70153_n != null) {
                ...
                ((EntityLivingBase)this.field_70153_n).func_70690_d(new PotionEffect(Potion.field_76426_n.field_76415_H, 10, 0, true));
            }
            if (d0 < 1.0) {
                d2 = d0 * 2.0 - 1.0;
            ...
            if (d2 > d10 && this.speedMultiplier < 0.5) {
    ...
    protected void func_70064_a(double p_70064_1_, boolean p_70064_3_) {
        ...
        if (!p_70064_3_ && this.field_70170_p.func_147439_a(i, j - 1, k).func_149688_o() != Material.field_151586_h && this.field_70170_p.func_147439_a(i, j - 1, k).func_149688_o() != Material.field_151587_i && p_70064_1_ < 0.0) {
    ...
    public EntityItem func_70099_a(ItemStack p_70099_1_, float p_70099_2_) {
        if (p_70099_1_.field_77994_a != 0 && p_70099_1_.func_77973_b() != null) {
            EntityItemInvulnerable entityitem = new EntityItemInvulnerable(this.field_70170_p, this.field_70165_t, this.field_70163_u + (double)p_70099_2_, this.field_70161_v, p_70099_1_);
