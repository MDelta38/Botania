...
implements IGuiHandler {
    ...
    public void sendCustomPacketToAllNear(Packet packet, double range, Entity enity) {
        if (enity != null) {
            FMLCommonHandler.instance().getMinecraftServerInstance().func_71203_ab().func_148541_a(enity.field_70165_t, enity.field_70163_u, enity.field_70161_v, range, enity.field_70170_p.field_73011_w.field_76574_g, packet);
        }
    }
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch (ID) {
            case 1: {
                return new ContainerVisDynamo(player, (TileVisDynamo)world.func_147438_o(x, y, z));
            }
            case 2: {
                return new ContainerSoulExtractor(player.field_71071_by, (TileSoulExtractor)world.func_147438_o(x, y, z));
            }
            case 3: {
                return new ContainerInspiratron(player.field_71071_by, (TileInspiratron)world.func_147438_o(x, y, z));
            }
            case 4: {
                return new ContainerSoulforge(player, (TileSoulforge)world.func_147438_o(x, y, z));
            }
            case 5: {
                return new ContainerBloodInfuser(player, (TileBloodInfuser)world.func_147438_o(x, y, z));
            }
            case 6: {
                return new ContainerInjector(player);
            }
            case 7: {
                return new ContainerVat(player, (TileVat)world.func_147438_o(x, y, z));
            }
            case 8: {
                return new ContainerCase(player.field_71071_by, world, x, y, z);
            }
            case 9: {
                return new ContainerFingers(player.field_71071_by);
            }
        }
        return null;
    }
