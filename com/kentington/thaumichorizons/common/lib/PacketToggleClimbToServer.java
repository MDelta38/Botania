...
public class PacketToggleClimbToServer
implements IMessage,
IMessageHandler<PacketToggleClimbToServer, IMessage> {
    ...
    public IMessage onMessage(PacketToggleClimbToServer message, MessageContext ctx) {
        ...
        ((EntityInfusionProperties)player.getExtendedProperties((String)"CreatureInfusion")).toggleClimb = !((EntityInfusionProperties)player.getExtendedProperties((String)"CreatureInfusion")).toggleClimb;
        return null;
    }
}
