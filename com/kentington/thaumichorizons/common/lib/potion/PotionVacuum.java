...
extends Potion {
    ...
    public PotionVacuum(int par1, boolean par2, int par3) {
        ...
        this.func_76399_b(2, 0);
    }

    public static void init() {
        instance.func_76390_b("potion.vacuum");
        instance.func_76399_b(2, 0);
    ...
    public void func_76394_a(EntityLivingBase player, int par2) {
    }
}
