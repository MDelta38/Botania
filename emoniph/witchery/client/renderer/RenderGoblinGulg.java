...
extends RenderLiving {
    ...
    protected int shouldRenderPass(EntityLiving par1EntityLiving, int par2, float par3) {
        ...
        if (itemstack != null && (item = itemstack.func_77973_b()) instanceof ItemArmor) {
            ...
            this.func_110776_a(RenderGoblinGulg.getArmorResource((Entity)par1EntityLiving, itemstack, par2, null));
    ...
    protected void func_82408_c(EntityLiving par1EntityLivingBase, int par2, float par3) {
        ...
        if (itemstack != null && (item = itemstack.func_77973_b()) instanceof ItemArmor) {
            this.func_110776_a(RenderGoblinGulg.getArmorResource((Entity)par1EntityLivingBase, itemstack, par2, "overlay"));
            float f1 = 1.0f;
            GL11.glColor3f((float)1.0f, (float)1.0f, (float)1.0f);
        }
    }
    ...
    public void func_76986_a(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
        GL11.glColor3f((float)1.0f, (float)1.0f, (float)1.0f);
        BossStatus.func_82824_a((IBossDisplayData)((EntityGoblinGulg)par1EntityLiving), (boolean)true);
