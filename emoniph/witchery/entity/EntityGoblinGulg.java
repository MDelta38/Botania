...
IHandleDT {
    ...
    public EntityGoblinGulg(World world) {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIMoveTowardsEntityClass((EntityCreature)this, EntityGoblinMog.class, 1.0, 6.0f, 64.0f));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIMoveTowardsTarget((EntityCreature)this, 1.0, 48.0f));
    ...
    public String func_70005_c_() {
        ...
        return StatCollector.func_74838_a((String)"entity.witchery.goblingulg.name");
    }
    ...
    public boolean func_70652_k(Entity par1Entity) {
        ...
        boolean flag = par1Entity.func_70097_a(DamageSource.func_76358_a((EntityLivingBase)this), (float)(6 + this.field_70146_Z.nextInt(force)));
        if (flag) {
            par1Entity.field_70181_x += 0.5 + height;
        }
