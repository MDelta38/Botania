...
extends EntityFlyingTameable {
    ...
    public double func_70042_X() {
        return this.field_70153_n != null ? (double)(-this.field_70153_n.field_70131_O) * 0.6 : 0.0;
    }
    ...
    public boolean func_70085_c(EntityPlayer player) {
        ...
        if (this.func_70909_n()) {
            ...
            if (TameableUtil.isOwner(this, player) && this.func_70877_b(itemstack) && this.func_110143_aJ() < this.func_110138_aP()) {
                if (!this.field_70170_p.field_72995_K) {
        ...
        if (itemstack != null && (itemstack.func_77973_b() == Items.field_151147_al || itemstack.func_77973_b() == Items.field_151082_bd) && player.func_70068_e((Entity)this) < 9.0) {
            if (!player.field_71075_bZ.field_75098_d) {
                --itemstack.field_77994_a;
            }
            if (itemstack.field_77994_a <= 0) {
    ...
    public String func_70005_c_() {
        ...
        return StatCollector.func_74838_a((String)"entity.witchery.wingedmonkey.name");
    }
