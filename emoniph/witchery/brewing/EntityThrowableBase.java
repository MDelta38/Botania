...
public abstract class EntityThrowableBase
extends Entity {
    ...
    public EntityThrowableBase(World world, EntityLivingBase thrower, float pitchShift) {
        ...
        this.field_70181_x = -MathHelper.func_76126_a((float)((this.field_70125_A + pitchShift) / 180.0f * (float)Math.PI)) * f;
    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (!entity1.func_70067_L() || !(entity1 instanceof EntityLivingBase) || entity1 == entitylivingbase && this.ticksInAir < 5 || (movingobjectposition1 = (axisalignedbb = entity1.field_70121_D.func_72314_b((double)(f = 0.3f), (double)f, (double)f)).func_72327_a(vec3, vec31)) == null || !((d1 = vec3.func_72438_d(movingobjectposition1.field_72307_f)) < d0) && d0 != 0.0) continue;
                entity = entity1;
                d0 = d1;
            }
            if (entity != null) {
        ...
        if (movingobjectposition != null && (movingobjectposition.field_72313_a != MovingObjectPosition.MovingObjectType.BLOCK || this.field_70170_p.func_147439_a(movingobjectposition.field_72311_b, movingobjectposition.field_72312_c, movingobjectposition.field_72309_d) != Blocks.field_150427_aO)) {
