...
extends BlockBaseContainer {
    ...
    public void func_149689_a(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
        ...
        int i1 = l & 7;
        int j1 = l & 8;
        if (i1 == BlockLeverBase.invertMetadata(1)) {
            if ((MathHelper.func_76128_c((double)((double)(p_149689_5_.field_70177_z * 4.0f / 360.0f) + 0.5)) & 1) == 0) {
        ...
        } else if (i1 == BlockLeverBase.invertMetadata(0)) {
            if ((MathHelper.func_76128_c((double)((double)(p_149689_5_.field_70177_z * 4.0f / 360.0f) + 0.5)) & 1) == 0) {
    ...
    public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        world.func_72908_a((double)x + 0.5, (double)y + 0.5, (double)z + 0.5, "random.click", 0.3f, k1 > 0 ? 0.6f : 0.5f);
        ...
        if (!world.field_72995_K && (tile = BlockUtil.getTileEntity((IBlockAccess)world, x, y, z, TileEntityCursedBlock.class)) != null && tile.nbtEffect != null && !tile.applyToEntityAndDestroy((Entity)player)) {
    ...
    public void func_149749_a(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_) {
        if ((p_149749_6_ & 8) > 0) {
            p_149749_1_.func_147459_d(p_149749_2_, p_149749_3_, p_149749_4_, (Block)this);
            int i1 = p_149749_6_ & 7;
            if (i1 == 1) {
                p_149749_1_.func_147459_d(p_149749_2_ - 1, p_149749_3_, p_149749_4_, (Block)this);
            } else if (i1 == 2) {
                p_149749_1_.func_147459_d(p_149749_2_ + 1, p_149749_3_, p_149749_4_, (Block)this);
            } else if (i1 == 3) {
                p_149749_1_.func_147459_d(p_149749_2_, p_149749_3_, p_149749_4_ - 1, (Block)this);
            } else if (i1 == 4) {
                p_149749_1_.func_147459_d(p_149749_2_, p_149749_3_, p_149749_4_ + 1, (Block)this);
            } else if (i1 != 5 && i1 != 6) {
                if (i1 == 0 || i1 == 7) {
                    p_149749_1_.func_147459_d(p_149749_2_, p_149749_3_ + 1, p_149749_4_, (Block)this);
                }
            } else {
                p_149749_1_.func_147459_d(p_149749_2_, p_149749_3_ - 1, p_149749_4_, (Block)this);
            }
