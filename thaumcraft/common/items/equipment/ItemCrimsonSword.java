...
IWarpingGear {
    public static Item.ToolMaterial toolMatCrimsonVoid = EnumHelper.addToolMaterial((String)"CVOID", (int)4, (int)200, (float)8.0f, (float)3.5f, (int)20);
    public IIcon icon;
    ...
    public void func_94581_a(IIconRegister ir) {
        this.icon = ir.func_94245_a("thaumcraft:crimson_blade");
    }
    ...
    public boolean func_77644_a(ItemStack is, EntityLivingBase target, EntityLivingBase hitter) {
        if (!(target.field_70170_p.field_72995_K || target instanceof EntityPlayer && hitter instanceof EntityPlayer && !MinecraftServer.func_71276_C().func_71219_W())) {
            try {
                ...
                target.func_70690_d(new PotionEffect(Potion.field_76438_s.func_76396_c(), 120));
            }
            catch (Exception e) {
                // empty catch block
            }
