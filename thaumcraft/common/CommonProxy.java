...
implements IGuiHandler {
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch (ID) {
            case 0: {
                return new ContainerGolem(player.field_71071_by, ((EntityGolemBase)((WorldServer)world).func_73045_a((int)x)).inventory);
            }
            case 1: {
                return new ContainerPech(player.field_71071_by, world, (EntityPech)((WorldServer)world).func_73045_a(x));
            }
            case 2: {
                return new ContainerTravelingTrunk((IInventory)player.field_71071_by, world, (EntityTravelingTrunk)((WorldServer)world).func_73045_a(x));
            }
            case 9: {
            ...
            case 18: {
                return new ContainerMagicBox((IInventory)player.field_71071_by, (TileMagicBox)world.func_147438_o(x, y, z));
            }
            case 19: {
