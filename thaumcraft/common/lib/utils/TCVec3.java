...
import thaumcraft.common.lib.utils.TCVec3Pool;
...
public class TCVec3 {
    ...
    public TCVec3 normalize() {
        double var1 = MathHelper.func_76133_a((double)(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord));
    ...
    public void rotateAroundX(float par1) {
        float var2 = MathHelper.func_76134_b((float)par1);
        float var3 = MathHelper.func_76126_a((float)par1);
