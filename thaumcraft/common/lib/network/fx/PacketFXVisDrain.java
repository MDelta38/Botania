...
public class PacketFXVisDrain
implements IMessage,
IMessageHandler<PacketFXVisDrain, IMessage> {
    private int x;
    private int y;
    private int z;
    private int color;
    ...
    public IMessage onMessage(PacketFXVisDrain message, MessageContext ctx) {
        ...
        FXVisSparkle fb = new FXVisSparkle(worldObj, (double)message.dx + 0.4 + (double)(worldObj.field_73012_v.nextFloat() * 0.2f), (double)message.dy + 0.4 + (double)(worldObj.field_73012_v.nextFloat() * 0.2f), (double)message.dz + 0.4 + (double)(worldObj.field_73012_v.nextFloat() * 0.2f), (float)message.x + worldObj.field_73012_v.nextFloat(), (float)message.y + worldObj.field_73012_v.nextFloat(), (float)message.z + worldObj.field_73012_v.nextFloat());
