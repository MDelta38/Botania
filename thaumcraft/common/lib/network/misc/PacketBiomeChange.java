...
implements IMessage,
IMessageHandler<PacketBiomeChange, IMessage> {
    private int x;
    private int z;
    private short biome;
    ...
    public IMessage onMessage(PacketBiomeChange message, MessageContext ctx) {
        Utils.setBiomeAt(Thaumcraft.proxy.getClientWorld(), message.x, message.z, BiomeGenBase.func_150568_d((int)message.biome));
        return null;
    }
}
