...
extends WorldGenAbstractTree {
        ...
        for (int var12 = -var7; var12 <= var7; ++var12) {
            ...
            while (var13 <= var7) {
                ...
                if (!(block != Blocks.field_150350_a && block != ConfigBlocks.blockMagicalLeaves || block != null && !block.canBeReplacedByLeaves((IBlockAccess)this.worldObj, var11[0], var11[1], var11[2]))) {
                    this.func_150516_a(this.worldObj, var11[0], var11[1], var11[2], par6, 1);
                }
                ++var13;
            }
        }
        ...
        if (var4[var6] != 0) {
            ...
            for (int var15 = 0; var15 != var16; var15 += var9) {
                ...
                if (this.rand.nextInt(50) == 0) {
                    this.func_150516_a(this.worldObj, var14[0], var14[1], var14[2], par3, var17 + 2);
                    ThaumcraftWorldGenerator.createRandomNodeAt(this.worldObj, var14[0], var14[1], var14[2], this.rand, true, false, false);
                    continue;
                }
                this.func_150516_a(this.worldObj, var14[0], var14[1], var14[2], par3, var17 + 1);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        for (var14 = 0; var14 != var15; var14 += var8) {
            ...
            if (var16 != Blocks.field_150350_a && var16 != ConfigBlocks.blockMagicalLeaves) break;
        }
    ...
    public boolean func_76484_a(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        flowers.func_76484_a(par1World, par2Random, par3, par4, par5);
        this.basePos[0] = par3;
        return true;
    }
}
