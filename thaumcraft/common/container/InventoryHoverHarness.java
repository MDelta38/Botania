...
implements IInventory {
    ...
    public boolean func_94041_b(int i, ItemStack jar) {
        AspectList aspects;
        return jar != null && jar.func_77973_b() instanceof ItemJarFilled && jar.func_77942_o() && (aspects = ((ItemJarFilled)jar.func_77973_b()).getAspects(jar)) != null && aspects.size() > 0 && aspects.getAmount(Aspect.ENERGY) > 0;
    }
