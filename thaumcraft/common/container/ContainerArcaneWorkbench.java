...
extends Container {
    ...
    public ContainerArcaneWorkbench(InventoryPlayer par1InventoryPlayer, TileArcaneWorkbench e) {
        ...
        this.func_75146_a((Slot)new SlotCraftingArcaneWorkbench(par1InventoryPlayer.field_70458_d, this.tileEntity, this.tileEntity, 9, 160, 64));
        this.func_75146_a(new SlotLimitedByWand(this.tileEntity, 10, 160, 24));
    ...
    public void func_75130_a(IInventory par1IInventory) {
        ...
        this.tileEntity.setInventorySlotContentsSoftly(9, CraftingManager.func_77594_a().func_82787_a(ic, this.tileEntity.func_145831_w()));
        if (this.tileEntity.func_70301_a(9) == null && this.tileEntity.func_70301_a(10) != null && this.tileEntity.func_70301_a(10).func_77973_b() instanceof ItemWandCasting && (wand = (ItemWandCasting)this.tileEntity.func_70301_a(10).func_77973_b()).consumeAllVisCrafting(this.tileEntity.func_70301_a(10), this.ip.field_70458_d, ThaumcraftCraftingManager.findMatchingArcaneRecipeAspects(this.tileEntity, this.ip.field_70458_d), false)) {
            this.tileEntity.setInventorySlotContentsSoftly(9, ThaumcraftCraftingManager.findMatchingArcaneRecipe(this.tileEntity, this.ip.field_70458_d));
        }
    }
