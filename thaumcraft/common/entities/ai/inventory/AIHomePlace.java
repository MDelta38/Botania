...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        ...
        while (repeat) {
            ...
            if (tile != null && tile instanceof IInventory && !ItemStack.func_77989_b((ItemStack)(result = InventoryUtils.placeItemStackIntoInventory(this.theGolem.getCarried(), (IInventory)tile, facing.ordinal(), false)), (ItemStack)this.theGolem.itemCarried)) {
                return true;
            }
