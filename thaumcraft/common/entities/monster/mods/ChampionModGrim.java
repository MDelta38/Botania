...
implements IChampionModifierEffect {
    ...
    public float performEffect(EntityLivingBase boss, EntityLivingBase target, DamageSource source, float amount) {
        if (boss.field_70170_p.field_73012_v.nextFloat() < 0.4f) {
            target.func_70690_d(new PotionEffect(Potion.field_82731_v.field_76415_H, 200));
        }
        return amount;
    }
    ...
    public void showFX(EntityLivingBase boss) {
        ...
        Thaumcraft.proxy.drawGenericParticles(boss.field_70170_p, boss.field_70121_D.field_72340_a + (double)w, boss.field_70121_D.field_72338_b + (double)h, boss.field_70121_D.field_72339_c + (double)d, 0.0, -0.02, 0.0, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, 0.8f, false, 160, 10, 1, 8 + boss.field_70170_p.field_73012_v.nextInt(4), 0, 0.6f + boss.field_70170_p.field_73012_v.nextFloat() * 0.4f);
    }
}
