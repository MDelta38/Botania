...
import thaumcraft.common.entities.monster.mods.ChampionModArmored;
import thaumcraft.common.entities.monster.mods.ChampionModBold;
import thaumcraft.common.entities.monster.mods.ChampionModFire;
import thaumcraft.common.entities.monster.mods.ChampionModGrim;
import thaumcraft.common.entities.monster.mods.ChampionModInfested;
import thaumcraft.common.entities.monster.mods.ChampionModMighty;
import thaumcraft.common.entities.monster.mods.ChampionModPoison;
import thaumcraft.common.entities.monster.mods.ChampionModSickly;
import thaumcraft.common.entities.monster.mods.ChampionModSpined;
import thaumcraft.common.entities.monster.mods.ChampionModUndying;
import thaumcraft.common.entities.monster.mods.ChampionModVampire;
import thaumcraft.common.entities.monster.mods.ChampionModWarded;
import thaumcraft.common.entities.monster.mods.ChampionModWarp;
...
public class ChampionModifier {
    ...
    public static AttributeModifier ATTRIBUTE_MOD_NONE = new AttributeModifier(UUID.fromString("1e645a3d-9115-4807-a61c-705172839f87"), "normal", 1.0, 0);
    ...
    public String getModNameLocalized() {
        return StatCollector.func_74838_a((String)("champion.mod." + this.name));
    }
}
