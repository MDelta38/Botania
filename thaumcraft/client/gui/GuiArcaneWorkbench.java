...
extends GuiContainer {
    ...
    protected void func_146976_a(float par1, int par2, int par3) {
        ...
        if (ThaumcraftCraftingManager.findMatchingArcaneRecipe(this.tileEntity, this.ip.field_70458_d) != null) {
            cost = ThaumcraftCraftingManager.findMatchingArcaneRecipeAspects(this.tileEntity, this.ip.field_70458_d);
            int count = 0;
            for (Aspect primal : this.primals) {
                ...
                if (cost.getAmount(primal) > 0) {
                    ...
                    UtilsFX.drawTag(var5 + this.aspectLocs[count][0] - 8, var6 + this.aspectLocs[count][1] - 8, primal, amt, 0, (double)this.field_73735_i, 771, alpha, false);
                }
                if (++count <= 5) continue;
                break;
            }
        ...
        if (wand != null && cost != null && !wand.consumeAllVisCrafting(this.tileEntity.func_70301_a(10), this.ip.field_70458_d, cost, false)) {
            ...
            GuiArcaneWorkbench.field_146296_j.field_77024_a = false;
            GL11.glEnable((int)2896);
            GL11.glEnable((int)2884);
            GL11.glEnable((int)3042);
            field_146296_j.func_82406_b(this.field_146297_k.field_71466_p, this.field_146297_k.field_71446_o, ThaumcraftCraftingManager.findMatchingArcaneRecipe(this.tileEntity, this.ip.field_70458_d), var5 + 160, var6 + 64);
            field_146296_j.func_77021_b(this.field_146297_k.field_71466_p, this.field_146297_k.field_71446_o, ThaumcraftCraftingManager.findMatchingArcaneRecipe(this.tileEntity, this.ip.field_70458_d), var5 + 160, var6 + 64);
            GuiArcaneWorkbench.field_146296_j.field_77024_a = true;
            GL11.glDisable((int)3042);
