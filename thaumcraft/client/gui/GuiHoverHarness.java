...
public class GuiHoverHarness
extends GuiContainer {
    private int blockSlot;

    public GuiHoverHarness(InventoryPlayer par1InventoryPlayer, World world, int x, int y, int z) {
        super((Container)new ContainerHoverHarness(par1InventoryPlayer, world, x, y, z));
    ...
    protected void func_146979_b(int par1, int par2) {
        ...
        this.func_73729_b(8 + this.blockSlot * 18, 142, 240, 0, 16, 16);
