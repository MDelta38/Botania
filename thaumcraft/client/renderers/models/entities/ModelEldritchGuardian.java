...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof EntityEldritchWarden) {
            ...
            int j = (int)(195.0f + MathHelper.func_76126_a((float)((float)entity.field_70173_aa / 3.0f)) * 15.0f + 15.0f);
            int k = j % 65536;
            int l = j / 65536;
    ...
    public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
        ...
        this.HoodEye.field_78795_f = this.Hood1.field_78795_f = par5 / 57.295776f;
        ...
        this.ArmL1.field_78795_f = -1.0f - all + MathHelper.func_76126_a((float)(((float)(entity.field_70173_aa + 20) + this.partialTicks) / 10.0f)) * 0.08f;
        this.ArmR1.field_78795_f = -1.0f - alr + MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks) / 10.0f)) * 0.08f;
        this.LegpanelC1.field_78795_f = -0.15f + MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks) / 8.0f)) * 0.12f;
        this.LegpanelC2.field_78795_f = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 5.0f) / 8.0f)) * 0.13f;
        this.LegpanelC3.field_78795_f = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 10.0f) / 8.0f)) * 0.14f;
        this.Cloak1.field_78795_f = 0.2f + MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks) / 7.0f)) * 0.08f;
        this.Cloak2.field_78795_f = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 5.0f) / 7.0f)) * 0.1f;
        this.Cloak3.field_78795_f = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 10.0f) / 7.0f)) * 0.12f;
        this.SidepanelL2.field_78808_h = -0.2f + MathHelper.func_76126_a((float)(((float)(entity.field_70173_aa + 10) + this.partialTicks) / 8.0f)) * 0.12f;
        this.SidepanelL3.field_78808_h = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks + 5.0f) / 8.0f)) * 0.13f;
        this.SidepanelL4.field_78808_h = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks) / 8.0f)) * 0.14f;
        this.SidepanelR2.field_78808_h = 0.2f + MathHelper.func_76126_a((float)(((float)(entity.field_70173_aa - 5) + this.partialTicks) / 8.0f)) * 0.12f;
        this.SidepanelR3.field_78808_h = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 10.0f) / 8.0f)) * 0.13f;
        this.SidepanelR4.field_78808_h = MathHelper.func_76126_a((float)(((float)entity.field_70173_aa + this.partialTicks - 15.0f) / 8.0f)) * 0.14f;
    }
