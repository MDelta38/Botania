...
extends TileEntitySpecialRenderer {
    ...
    public void func_147500_a(TileEntity te, double x, double y, double z, float f) {
        ...
        if (!te.func_145831_w().func_147439_a(te.field_145851_c, te.field_145848_d + 1, te.field_145849_e).func_149662_c()) {
            this.drawPlaneYNeg(x, y, z, f);
        }
        if (!te.func_145831_w().func_147439_a(te.field_145851_c, te.field_145848_d - 1, te.field_145849_e).func_149662_c()) {
            this.drawPlaneYPos(x, y, z, f);
        }
        if (!te.func_145831_w().func_147439_a(te.field_145851_c, te.field_145848_d, te.field_145849_e - 1).func_149662_c()) {
            this.drawPlaneZPos(x, y, z, f);
        }
        if (!te.func_145831_w().func_147439_a(te.field_145851_c, te.field_145848_d, te.field_145849_e + 1).func_149662_c()) {
            this.drawPlaneZNeg(x, y, z, f);
        }
        if (!te.func_145831_w().func_147439_a(te.field_145851_c - 1, te.field_145848_d, te.field_145849_e).func_149662_c()) {
