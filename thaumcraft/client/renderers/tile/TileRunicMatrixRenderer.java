...
extends TileEntitySpecialRenderer {
    ...
    public void renderInfusionMatrix(TileInfusionMatrix is, double par2, double par4, double par6, float par8) {
        ...
        for (a = 0; a < 2; ++a) {
            for (b = 0; b < 2; ++b) {
                for (c = 0; c < 2; ++c) {
                    if (is.active) {
                        b1 = MathHelper.func_76126_a((float)((ticks + (float)(a * 10)) / (15.0f - instability / 2.0f))) * 0.01f * is.startUp * instability;
                        b2 = MathHelper.func_76126_a((float)((ticks + (float)(b * 10)) / (14.0f - instability / 2.0f))) * 0.01f * is.startUp * instability;
                        b3 = MathHelper.func_76126_a((float)((ticks + (float)(c * 10)) / (13.0f - instability / 2.0f))) * 0.01f * is.startUp * instability;
                    }
                    aa = a == 0 ? -1 : 1;
                    bb = b == 0 ? -1 : 1;
                    cc = c == 0 ? -1 : 1;
            ...
            for (a = 0; a < 2; ++a) {
                for (b = 0; b < 2; ++b) {
                    for (c = 0; c < 2; ++c) {
                        ...
                        GL11.glColor4f((float)0.8f, (float)0.1f, (float)1.0f, (float)((MathHelper.func_76126_a((float)((ticks + (float)(a * 2) + (float)(b * 3) + (float)(c * 4)) / 4.0f)) * 0.1f + 0.2f) * is.startUp));
    ...
    public void func_147500_a(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
        switch (this.type) {
            ...
            case 1: {
                this.func_147500_a((TileInfusionMatrix)par1TileEntity, par2, par4, par6, par8);
            }
        }
    }
}
