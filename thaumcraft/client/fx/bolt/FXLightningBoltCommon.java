...
public class FXLightningBoltCommon {
    ...
    public FXLightningBoltCommon(World world, Entity detonator, Entity target, long seed, int speed) {
        this(world, new WRVector3(detonator), new WRVector3(target.field_70165_t, target.field_70163_u + (double)target.func_70047_e() - (double)0.7f, target.field_70161_v), seed);
