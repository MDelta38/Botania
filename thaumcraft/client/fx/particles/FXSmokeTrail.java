...
extends EntityFX {
    ...
    public void func_70539_a(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
        float bob = MathHelper.func_76126_a((float)((float)this.field_70546_d / 3.0f)) * 0.33f + 0.66f;
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)0.33f);
        int part = (int)(1.0f + (float)this.field_70546_d / (float)this.field_70547_e * 4.0f);
        float var8 = (float)(part % 16) / 16.0f;
        float var9 = var8 + 0.0624375f;
        float var10 = (float)(part / 16) / 16.0f;
        float var11 = var10 + 0.0624375f;
        float var12 = 0.3f * this.field_70544_f * bob;
        ...
        tessellator.func_78369_a(this.field_70552_h * var16, this.field_70553_i * var16, this.field_70551_j * var16, 0.33f);
