...
extends EntityFX {
    ...
    public void setFroth() {
        ...
        this.field_70547_e = 4 + this.field_70146_Z.nextInt(3);
    ...
    public void setFroth2() {
        this.field_70544_f *= 0.75f;
        this.field_70547_e = 12 + this.field_70146_Z.nextInt(12);
    ...
    public void func_70071_h_() {
        ...
        this.field_70167_r = this.field_70163_u;
        this.field_70166_s = this.field_70161_v;
        this.field_70181_x += this.bubblespeed;
        if (this.bubblespeed > 0.0) {
            this.field_70159_w += (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) * 0.01f);
            this.field_70179_y += (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) * 0.01f);
        }
