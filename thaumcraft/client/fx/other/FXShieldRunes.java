...
extends EntityFX {
    ...
    public FXShieldRunes(World world, double d, double d1, double d2, Entity target, int age, float yaw, float pitch) {
        ...
        this.field_70167_r = this.field_70163_u = (target.field_70121_D.field_72338_b + target.field_70121_D.field_72337_e) / 2.0;
    ...
    public void func_70539_a(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GL11.glRotatef((float)(180.0f - this.yaw), (float)0.0f, (float)1.0f, (float)0.0f);
