...
extends EntityFX {
    ...
    public FXSonic(World world, double d, double d1, double d2, Entity target, int age) {
        ...
        this.field_70169_q = this.field_70165_t = target.field_70165_t;
        this.field_70167_r = this.field_70163_u = target.field_70163_u + (double)target.func_70047_e();
        this.field_70166_s = this.field_70161_v = target.field_70161_v;
    }
    ...
    public void func_70539_a(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GL11.glTranslated((double)0.0, (double)0.0, (double)(2.0f * this.target.field_70131_O + this.target.field_70130_N / 2.0f));
        GL11.glScaled((double)(0.25 * (double)this.target.field_70131_O), (double)(0.25 * (double)this.target.field_70131_O), (double)(-1.0f * this.target.field_70131_O));
    ...
    public void func_70071_h_() {
        ...
        this.field_70163_u = this.target.field_70163_u + (double)this.target.func_70047_e();
