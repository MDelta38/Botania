...
public class CrucibleRecipe {
    ...
    public boolean matches(AspectList itags, ItemStack cat) {
        ...
        if (this.catalyst instanceof ArrayList && ((ArrayList)this.catalyst).size() > 0 && !ThaumcraftApiHelper.containsMatch(false, new ItemStack[]{cat}, ores = ((ArrayList)this.catalyst).toArray(new ItemStack[0]))) {
            return false;
        }
        if (itags == null) {
            return false;
    ...
    public boolean catalystMatches(ItemStack cat) {
        ...
        return this.catalyst instanceof ArrayList && ((ArrayList)this.catalyst).size() > 0 && ThaumcraftApiHelper.containsMatch(false, new ItemStack[]{cat}, ores = ((ArrayList)this.catalyst).toArray(new ItemStack[0]));
    }
