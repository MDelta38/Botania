...
public class CloakColourizationRecipe
implements IRecipe {
    public boolean func_77569_a(InventoryCrafting par1InventoryCrafting, World par2World) {
        ...
        for (int i = 0; i < par1InventoryCrafting.func_70302_i_(); ++i) {
            ...
            if (itemstack1.func_77973_b() instanceof ItemCloak) {
                boolean flag_wonttakecolour;
                boolean bl = flag_wonttakecolour = itemstack1.func_77960_j() != 0;
    ...
    public ItemStack func_77572_b(InventoryCrafting par1InventoryCrafting) {
        ...
        for (k = 0; k < par1InventoryCrafting.func_70302_i_(); ++k) {
            ...
            if (itemstack1.func_77973_b() instanceof ItemCloak) {
                boolean flag_wonttakecolour;
                itemcloak = (ItemCloak)itemstack1.func_77973_b();
                boolean bl = flag_wonttakecolour = itemstack1.func_77960_j() != 0;
                if (itemstack != null || flag_wonttakecolour) {
                    return null;
                }
                ...
                if (!itemcloak.hasColor(itemstack1)) continue;
