...
import witchinggadgets.common.gui.SlotGhostSingleItem;
import witchinggadgets.common.items.tools.ItemBag;

public class ContainerVoidBag
extends ContainerGhostSlots {
    private World worldObj;
    private int blockedSlot;
    public IInventory input = new InventoryBag((Container)this);
    ...
    public ContainerVoidBag(InventoryPlayer iinventory, World world) {
        ...
        for (int a = 0; a < this.pouchSlotAmount; ++a) {
            this.func_75146_a((Slot)new SlotGhostSingleItem(this.input, a, 29 + a % 6 * 20, 7 + a / 6 * 20));
        }
