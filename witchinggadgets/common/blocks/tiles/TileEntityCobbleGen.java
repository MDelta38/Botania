...
extends TileEntityWGBase {
    ...
    private void createCobble() {
        ...
        TileEntity inventory = this.field_145850_b.func_147438_o(this.field_145851_c + this.facing.offsetX, this.field_145848_d + this.facing.offsetY, this.field_145849_e + this.facing.offsetZ);
        if (inventory != null && inventory instanceof IInventory) {
            cobble = InventoryUtils.placeItemStackIntoInventory((ItemStack)cobble, (IInventory)((IInventory)inventory), (int)this.facing.getOpposite().ordinal(), (boolean)true);
        }
        if (cobble != null) {
            if (this.facing.equals((Object)ForgeDirection.UP) || this.facing.equals((Object)ForgeDirection.DOWN)) {
                EntityItem ei = new EntityItem(this.field_145850_b, (double)this.field_145851_c + 0.5, (double)this.field_145848_d + 0.5 + (double)this.facing.offsetY * 0.66, (double)this.field_145849_e + 0.5, cobble.func_77946_l());
                ...
                EntityItem ei = new EntityItem(this.field_145850_b, (double)this.field_145851_c + 0.5 + (double)this.facing.offsetX * 0.66, (double)this.field_145848_d + 0.4 + (double)this.facing.getOpposite().offsetY, (double)this.field_145849_e + 0.5 + (double)this.facing.offsetZ * 0.66, cobble.func_77946_l());
    ...
    private boolean canOutput() {
        TileEntity inventory = this.field_145850_b.func_147438_o(this.field_145851_c + this.facing.offsetX, this.field_145848_d + this.facing.offsetY, this.field_145849_e + this.facing.offsetZ);
        if (inventory != null && inventory instanceof IInventory) {
            return InventoryUtils.insertStack((IInventory)((IInventory)inventory), (ItemStack)new ItemStack(Blocks.field_150347_e), (int)this.facing.getOpposite().ordinal(), (boolean)false) == null;
        }
        return true;
    }
