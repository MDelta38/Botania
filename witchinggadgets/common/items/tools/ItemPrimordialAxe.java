...
public class ItemPrimordialAxe
extends ItemAxe
...
IPrimordialGear {
    IIcon overlay;
    public static Material[] validMats = new Material[]{Material.field_151570_A, Material.field_151572_C, Material.field_151584_j, Material.field_151585_k, Material.field_151582_l, Material.field_151575_d};

    public ItemPrimordialAxe(Item.ToolMaterial mat) {
        super(mat);
    }
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity target) {
        if (target instanceof EntityLivingBase) {
            for (int i = 1; i < 4; ++i) {
                if (((EntityLivingBase)target).func_71124_b(i) == null || !(((EntityLivingBase)target).func_71124_b(i).func_77973_b() instanceof ItemArmor)) continue;
                ItemStack armor = ((EntityLivingBase)target).func_71124_b(i);
                if (armor.func_77973_b() instanceof ISpecialArmor) {
                    ((ISpecialArmor)armor.func_77973_b()).damageArmor((EntityLivingBase)target, armor, DamageSource.func_76365_a((EntityPlayer)player), 4, EntityLiving.func_82159_b((ItemStack)armor) - 1);
                } else {
                    stack.func_77972_a(5, (EntityLivingBase)target);
                }
                if (stack.field_77994_a > 0) continue;
                ((EntityLivingBase)target).func_70062_b(i, null);
            }
    ...
    public void func_94581_a(IIconRegister iconRegister) {
        this.field_77791_bV = iconRegister.func_94245_a("witchinggadgets:primordialAxe");
        this.overlay = iconRegister.func_94245_a("witchinggadgets:primordialAxe_overlay");
    }
    ...
    public boolean onBlockStartBreak(ItemStack stack, int ix, int iy, int iz, EntityPlayer player) {
        ...
        int[] range = new int[]{side == 4 || side == 5 ? 0 : 1, side == 0 || side == 1 ? 0 : 1, side == 2 || side == 3 ? 0 : 1};
    ...
    public float getDigSpeed(ItemStack stack, Block block, int meta) {
        if (block.func_149688_o() == Material.field_151584_j || block.func_149688_o() == Material.field_151582_l) {
            return 6.0f;
        }
