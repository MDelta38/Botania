...
public class ModelPrimordialBaubles
extends ModelBiped {
    ...
    public ModelPrimordialBaubles(EntityLivingBase entity, ItemStack stack) {
        ...
        float sizeMod = slot == 1 ? 1.125f : 0.125f;
        ...
        ModelRenderer mr = new ModelRenderer((ModelBase)this, 40, 28);
        mr.func_78790_a(-3.0f, -2.0f + (float)yOff, 4.0f, 2, 1, 1, sizeMod);
