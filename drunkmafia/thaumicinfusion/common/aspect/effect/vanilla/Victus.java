...
extends AspectEffect {
    ...
    private static final int[] mobs = new int[]{90, 91, 92, 93};
    long cooldown;
    ...
    public void func_149674_a(World world, int x, int y, int z, Random random) {
        ...
        if (System.currentTimeMillis() > this.cooldown + 2000L && rand.nextInt(1000) == 1 && this.drainAspects(world, Aspect.LIFE)) {
